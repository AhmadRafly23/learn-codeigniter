...
<div class="p-6 w-2/5">
    <form action="/comic/save" method="post" enctype="multipart/form-data" class="space-y-4">
        <?= csrf_field(); ?>
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="w-full max-w-sm space-y-3">
                <img src="/img/default.png" alt="" class="img-preview w-36 h-40 rounded-lg object-cover border">
                <div>
                    <div class="container-file flex items-center border rounded-xl">
                        ...
                        <label id="file-input-label" for="cover" class="text-gray-400 px-3 truncate">No file selected.</label>
                    </div>
